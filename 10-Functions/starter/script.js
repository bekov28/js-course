...
1. Create a method called 'registerNewAnswer' on the 'poll' object. The method does 2 things:
  ...
  increase the value AT POSITION 3 of the array by 1. Make sure to check if 
  the input is a number and if the number makes sense (e.g answer 52 wouldn't 
  make sense, right?)
...
as it is, using console.log(). This should be the default option. 
